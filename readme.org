...
3. Alternative with =use-package=:

#+begin_src emacs-lisp
  (use-package org-expand-doi
    :load-path "~/.emacs.d/lisp/"
    :commands org-expand-doi-setup
    :init
...
* To do
- There is a problem when the script is byte compiled: in these cases the =json= functions do not work properly.
